...
Begin VB.Form frmUnionAdyacente 
   ...
   Caption         =   "Union con Mapas Adyacentes"
   ClientHeight    =   5235
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6165
   ...
   Begin VB.CheckBox AutoMapeo 
      ...
      Width           =   1095
   End
   Begin FXIIIWorldEditor.lvButtons_H cmdAplicar 
      Height          =   375
      Left            =   3240
      TabIndex        =   29
      Top             =   4080
   ...
   Begin VB.TextBox Mapa 
      ...
      Width           =   735
   End
   Begin FXIIIWorldEditor.lvButtons_H cmdCancelar 
      Height          =   375
      Left            =   4680
      TabIndex        =   30
      Top             =   4080
      ...
      cBack           =   -2147483633
   End
   Begin FXIIIWorldEditor.lvButtons_H cmdDefault 
      Height          =   375
      Left            =   120
      TabIndex        =   31
      Top             =   4080
...
modEdicion.Deshacer_Add "Insertar Translados a mapas Adyacentes" ' Hago deshacer
...
For Y = YMinMapSize To YMaxMapSize
    For X = XMinMapSize To XMaxMapSize
        If X < PosLim(3).Text Or X > PosLim(2).Text Or Y < PosLim(1).Text Or Y > PosLim(0).Text Then
...
MapData(PosLim(3).Text, PosLim(1).Text).Blocked = 1
MapData(PosLim(3).Text, PosLim(0).Text).Blocked = 1
MapData(PosLim(2).Text, PosLim(1).Text).Blocked = 1
MapData(PosLim(2).Text, PosLim(0).Text).Blocked = 1
End If
'Set changed flag
MapInfo.Changed = 1
DoEvents
...
'Last modified: 20/05/06
'*************************************************
'0&5 Down - 2&6 Right - 3&7 Left - 1&4 Up
PosLim(0).Text = 92
PosLim(5).Text = 10
